    ...
    <div style="margin-top: 30px">
        ...
        <form class="form-horizontal" role="form"
            ...
            <div class="form-group">
                <label for="name" class="col-sm-3 control-label">美食名</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="name" id="name"
                           placeholder="请输入美食名称" value="${requestScope.data.name}">
                </div>
            </div>
            <div class="form-group">
                <label for="image" class="col-sm-3 control-label">美食文件名</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="image" id="image"
                           placeholder="请输入美食照片文件名" value="${requestScope.data.image}">
                </div>
            </div>
            <div class="form-group">
                <label for="introduce" class="col-sm-3 control-label" style="margin-right: 17px">美食介绍</label>
                <textarea class="form-control col-sm-offset-3" rows="4" id="introduce" style="max-width: 720px"
                          placeholder="请输入美食介绍" name="introduce">${requestScope.data.introduce}</textarea>
            </div>
            <div class="form-group">
                <label for="price" class="col-sm-3 control-label">美食价格</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="price" name="price"
                           placeholder="请输入美食门票价格"  value="${requestScope.data.price}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="address" name="address"
                           placeholder="请输入美食地址" value="${requestScope.data.address}">
                </div>
            </div>
            <div class="form-group">
